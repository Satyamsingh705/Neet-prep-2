...
export default async function HomePage() {
  ...
  if (!student) {
    return (
      <main className="flex w-full flex-col gap-4 px-4 py-4 sm:gap-6 sm:px-[1.5%] sm:py-10">
  ...
  return (
    <main className="flex w-full flex-col gap-4 px-0 py-4 sm:gap-6 sm:px-[1.5%] sm:py-8 xl:px-[2%]">
      <section className="panel overflow-hidden rounded-none border-x-0 sm:rounded-[1.6rem] sm:border-x">
        <div className="grid gap-6 px-5 py-6 sm:gap-8 sm:px-8 sm:py-8 md:grid-cols-[1.2fr_0.8fr] lg:px-10 lg:py-10">
          ...
          <div className="grid gap-4 self-start sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2">
